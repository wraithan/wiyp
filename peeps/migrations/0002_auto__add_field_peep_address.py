...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Peep.address'
        db.add_column('peeps_peep', 'address', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['addresses.Address']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Peep.address'
        db.delete_column('peeps_peep', 'address_id')
    ...
    models = {
        ...
        'peeps.peep': {
            'Meta': {'object_name': 'Peep'},
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['addresses.Address']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'7680c578860939f7abbd83468fd6950db7f304eae90531df4fbc8ad8'", 'max_length': '64'}),
            'height': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '250'}),
            'uploader': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.PeepProfile']", 'null': 'True', 'blank': 'True'}),
            'width': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'profiles.peepprofile': {
            'Meta': {'object_name': 'PeepProfile'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
